...
const {
    ...
    (params) => fetch(`https://localhost/api/`,
        {
...
declare const useSearchAsyncData: <Data = any, SearchData extends Record<string, any> = any, Shallow extends boolean = boolean>(fn: (params?: any) => Promise<any>, options?: UseSearchAsyncData<Data, SearchData, Shallow> | undefined) => {
